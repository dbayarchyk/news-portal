...
describe("Comment Entity", () => {
  ...
  beforeEach(() => {
    comment = new Comment({
      content: Content.create("Nice comments!"),
      articleId: ArticleId.create("test-article"),
      authorId: AuthorId.create("test-author"),
      parentCommentId: ParentCommentId.create("test-comment-id"),
  ...
  describe("content getter", () => {
    it("should return content value", () => {
      expect(comment.content.equals(Content.create("Nice comments!"))).toBe(
        true
      );
    });
  });
  ...
  describe("articleId getter", () => {
    it("should return article id value", () => {
      expect(comment.articleId.equals(ArticleId.create("test-article"))).toBe(
        true
      );
    });
  });
  ...
  describe("authorId getter", () => {
    it("should return author id value", () => {
      expect(comment.authorId.equals(AuthorId.create("test-author"))).toBe(
        true
      );
    });
  });
