import { CommentEntityToDTOMapper } from "../comment-entity-to-dto-mapper";
...
describe("CommentEntityToDTOMapper", () => {
  describe("mapEntityToDTO", () => {
    it("should map comment entity to DTO", () => {
      ...
      expect(CommentEntityToDTOMapper.mapEntityToDTO(comment)).toEqual({
        id: "some-id",
